...
import com.pjt2.lb.common.auth.LBUserDetailsService;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	DaoAuthenticationProvider authenticationProvider() {
		...
		daoAuthenticationProvider.setUserDetailsService(this.lbUserDetailsService);
